...
void esp_bt_gap_cb(esp_bt_gap_cb_event_t event, esp_bt_gap_cb_param_t *param)
{
    ...
    case ESP_BT_GAP_DISC_RES_EVT: {
        // we could try to connect here but we don't have to
        break;
    }
...
static void i2sclockhack() {
    // this is very hacky, as the title implies. The hfp stack does not allow us to specify MCLK,
    // but the hardware peripheral I use requires it.
    // So we use the second i2s slot and mimic the frequency of the first to generate the MCLK signal.
    // See https://github.com/espressif/esp-idf/issues/14069
